...
static struct _cl_icd_dispatch disp = {
	...
	in_clRetainMemObject,
	in_clReleaseMemObject,
	...
	in_clCreateProgramWithSource,
	in_clCreateProgramWithBinary,
	in_clRetainProgram,
	in_clReleaseProgram,
	in_clBuildProgram,
	...
	in_clFlush,
	in_clFinish,
	in_clEnqueueReadBuffer,
	in_clEnqueueWriteBuffer,
	in_clEnqueueCopyBuffer,
	...
	in_clEnqueueMapBuffer,
	NULL, //in_clEnqueueMapImage,
	in_clEnqueueUnmapMemObject,
	in_clEnqueueNDRangeKernel,
	NULL, //in_clEnqueueTask,
	in_clEnqueueNativeKernel,
	...
	in_clEnqueueReadBufferRect,
	in_clEnqueueWriteBufferRect,
	in_clEnqueueCopyBufferRect,
